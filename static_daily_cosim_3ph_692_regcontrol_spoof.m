...
ExecSource = {'.ParseAction', '.ParseAction', '.ParseAction', ...
    ...
    '.Reversing', '.Reversing', ...    
    '.MakingTapChange.NonzeroTapChange', '.MakingTapChange.NonzeroTapChange', ...
    '.MakingTapChange.NonzeroTapChange', '.MakingTapChange.NonzeroTapChange', ...
    '.MakingTapChange.NonzeroTapChange', '.MakingTapChange.NonzeroTapChange', ...
    '.MakingTapChange.NonzeroTapChange', '.MakingTapChange.NonzeroTapChange', ...
    '.MakingTapChange.NonzeroTapChange', ...    
    '.MakingTapChange.NonzeroTapChange.Plus1Tap', '.MakingTapChange.NonzeroTapChange.Plus2Taps', ...
    '.MakingTapChange.NonzeroTapChange.Plus3Taps', '.MakingTapChange.NonzeroTapChange.PlusOver3Taps', ...
    '.MakingTapChange.NonzeroTapChange.Minus1Tap', '.MakingTapChange.NonzeroTapChange.Minus2Taps', ...
    '.MakingTapChange.NonzeroTapChange.Minus3Taps', '.MakingTapChange.NonzeroTapChange.MinusOver3Taps', ...    
    '.MakingTapChange.NonzeroTapChange.Finished', ...    
...
ExecDest = {'.MakingTapChange', '.Reversing', '.Finished', ...
    ...
    '.Reversing.FlipReverse', '.Reversing.Finished', ...    
    '.MakingTapChange.NonzeroTapChange.Plus1Tap', '.MakingTapChange.NonzeroTapChange.Plus2Taps', ...
    '.MakingTapChange.NonzeroTapChange.Plus3Taps', '.MakingTapChange.NonzeroTapChange.PlusOver3Taps', ...
    '.MakingTapChange.NonzeroTapChange.Minus1Tap', '.MakingTapChange.NonzeroTapChange.Minus2Taps', ...
    '.MakingTapChange.NonzeroTapChange.Minus3Taps', '.MakingTapChange.NonzeroTapChange.MinusOver3Taps', ...
    '.MakingTapChange.NonzeroTapChange.Finished', ...    
    '.MakingTapChange.NonzeroTapChange.Finished', '.MakingTapChange.NonzeroTapChange.Finished', ...
    '.MakingTapChange.NonzeroTapChange.Finished', '.MakingTapChange.NonzeroTapChange.Finished', ...
    '.MakingTapChange.NonzeroTapChange.Finished', '.MakingTapChange.NonzeroTapChange.Finished', ...
    '.MakingTapChange.NonzeroTapChange.Finished', '.MakingTapChange.NonzeroTapChange.Finished', ...    
    '.MakingTapChange.Finished', ...    
...
% PlotNormalized(execg, ExecBlockpath, 1, 1, '.ParseAction', '.Finished');
ExecGraph = struct;
...
LookingFwdSource = {'', '', ...
    ...
    '.CorrectFalseReversePending.Finished', ...
    '.CorrectTrueReversePending.FlipToFalse', '.CorrectTrueReversePending.Finished'};

LookingFwdDest = {'.CorrectFalseReversePending', '.CorrectTrueReversePending', ...
    ...
    '.Finished', ...
    '.CorrectTrueReversePending.Finished', '.Finished'};

LookingFwdBlockpath = 'Sampling.LookingForwardMode.DetermineReversePending';
...
for phase = 1:3
    ...
    MakeTCgraph = setfield(MakeTCgraph, regWsNames{phase}, mtcg);
    PlotNormalized(mtcg, MakeTCblockpath, MakeTCentries(phase), N, '', '.Finished');
...
% Not a Markov Chain:
figure(9);
PlotNormalizedOld(QHexecGraph, QHexecBlockpath, QHexecEntries, N);
...
%% Build chart of probabilities of events that occurred:
...
for nn = 1:N
    ...
    for phase = 1:3
        ...
        mtcprob = ProbOfSequence(getfield(MakeTCgraph, regWsNames{phase}), ...
            MakeTCentries(phase)/N, loclog);
        execprob = ProbOfSequence(getfield(ExecGraph, regWsNames{phase}), ...
            ExecEntries(phase)/N, loclog);
        lfwdprob = ProbOfSequence(getfield(LookingFwdGraph, regWsNames{phase}), ...
            LookingFwdEntries(phase)/N, loclog);      
        lrevprob = ProbOfSequence(getfield(LookingRevDRPgraph, regWsNames{phase}), ...
            LookingRevDRPentries(phase)/N, loclog);
        rncprob = ProbOfSequence(getfield(LookingRevRNCgraph, regWsNames{phase}), ...
            LookingRevRNCentries(phase)/N, loclog);
        ...
        probability_log(nn) = setfield(probability_log(nn), regWsNames{phase}, ...
...
figure(20);
loclog = find(simOut(8).logsout, '-regexp', 'BlockPath', ...
                    sprintf('\\w*%s\\w*', regWsNames{phase}));
                
h = PlotSequence(execg, ExecBlockpath, ExecEntries(phase), N, ...
        '.ParseAction', '.Finished', loclog);
    
%% demo of Probability Log:
probability_log = MakeProbChart(simOut, HourOutVals, SecOutVals, 1:3, ...
    {'MakeTC' 'Exec' 'LFwd' 'LRev' 'RevN'}, ...
    [MakeTCentries ExecEntries LookingFwdEntries LookingRevDRPentries LookingRevRNCentries], ...
