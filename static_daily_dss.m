...
kWRated = 7200;
kWhRated = 0.1*kWRated;
kWhStored = 145; %0.020*kWRated;
...
% Add PV
DSSText.command = 'Set DaisySize=2.5';
DSSText.command = 'set markregulators=yes';
DSSText.command = 'plot daisy power max=2000 dots=y buslist=(file=IEEE13Node_BusXY.csv)';
